...
$DOMAINS = "192.168.x.x localhost 127.0.0.1"
...
Write-Host "   scp `"$caCert`" dietpi@192.168.x.x:~/prism-ca.pem" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "   https://192.168.x.x" -ForegroundColor Yellow
Write-Host ""
Write-Host "Done. Prism will be available at https://192.168.x.x" -ForegroundColor Green
Write-Host ""
